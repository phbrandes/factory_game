...
- Copper
- Coal
- basic defense components
- basic weapons components
- basic logistics components
- basic power buildings and components
- basic production buildings
- basic mining buildings
...
- Circuits
- Power Components
- basic reasearch components
- unlock trading functions and npc factions
- higher capacity for giving and transporting resources required by the headquarters.
- basic locomotion solutions
- tier 2 defense components
- tier 2 weapons components
- tier 2 logistics components
Tier 3:
...
- Advanced Locomotion Solutions
- Tier 3 Defense Components
- Tier 3 Weapons Components
- Tier 3 Logistics Components
...
while also growing stronger with bigger nests, stronger units and higer numbers of enemies, and also having new enemy types that require the player to adapt and improve its strategy, factory design and defense design.
having premature waves of enemies attack the player if they been attacking the nests if before the main wave of enemies arrive, and also having event based enemy spawns that can be triggered by the player or by the environment. and also having a variety of enemy types that have different strengths and weaknesses.

main enemies would be slimes, orcs , squeletons, golens, bitters, spitters and higher tier enemies like alien bugs, mounted orcs, necromancers, alien robots, and so on.
